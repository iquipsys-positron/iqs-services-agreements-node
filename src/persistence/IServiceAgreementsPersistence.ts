...
export interface IServiceAgreementsPersistence extends IGetter<ServiceAgreementV1, string>, IWriter<ServiceAgreementV1, string> {
    ...
    getOneById(correlationId: string, id: string, 
        callback: (err: any, item: ServiceAgreementV1) => void): void;

    create(correlationId: string, item: ServiceAgreementV1, 
        callback: (err: any, item: ServiceAgreementV1) => void): void;

    update(correlationId: string, item: ServiceAgreementV1, 
        callback: (err: any, item: ServiceAgreementV1) => void): void;
